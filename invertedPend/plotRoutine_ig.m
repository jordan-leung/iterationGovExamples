...
xlabel('Time','interpreter','Latex','Fontsize',labelsize)
ylabel('$\phi$','interpreter','Latex','FontSize',labelsize)
...
plot(t(1:end-1),ellHist,'k','LineWidth',2)
hold on; box on; grid on;
plot(t,t*0+ellStar,'r--','linewidth',2)


subtightplot(2,3,6,subPlotGap,subPlotH,subPlotW);
semilogy(t(1:end-1),output.errorHist,'k','LineWidth',2)
ylabel('error')
grid on; box on;
